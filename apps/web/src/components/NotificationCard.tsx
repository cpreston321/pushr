      ...
      <div className="flex items-start gap-3 p-3.5">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-baseline justify-between gap-2">
            ...
            <span className="font-mono text-[10.5px] tabular-nums text-bone-dim/60">{n.time}</span>
          </div>
          <p className="mt-0.5 text-[14.5px] font-medium leading-snug text-bone">{n.title}</p>
          <p className="mt-0.5 line-clamp-2 text-[13px] leading-snug text-bone/70">{n.body}</p>
        </div>
      </div>
