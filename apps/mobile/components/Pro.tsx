 ...
 */
export function ProBadge({ size = 'sm', label = 'PRO' }: { size?: 'sm' | 'md'; label?: string }) {
...
export function ProUpsellCard({
  ...
  return (
    ...
    >
      ...
      <Text style={{ ...type.footnote, color: colors.accent, fontWeight: '600' }}>{cta}</Text>
    </Pressable>
  );
}
...
export function ProGate({
  ...
  return (
    ...
    >
      ...
      >
        <SymbolView name={icon ?? 'lock.fill'} size={18} tintColor={colors.accent} />
      </View>
      <View style={{ flex: 1 }}>
        <View
          style={{
